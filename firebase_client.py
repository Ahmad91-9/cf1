...
class FirebaseClient:
    ...
    @staticmethod
    def update_referral_membership_status(id_token: str, user_id: str, has_membership: bool, membership_type: str = "none") -> dict:
        """
                ...
                if "error" not in referrer_data:
                    ...
                    if referrer_code:
                        update_result = FirebaseClient._update_referral_code_membership_counts(
                            id_token, referrer_code, user_id, has_membership, membership_type
                        )
    ...
    @staticmethod
    def _update_referral_code_membership_counts(id_token: str, referral_code: str, user_id: str, has_membership: bool, membership_type: str) -> dict:
        """
    ...
    def update_user_membership(id_token: str, user_id: str, membership_data: dict) -> dict:
        ...
        try:
            ...
            return {"success": True, "membership_updated": True, "referral_sync": referral_result}
